...
df.add_system_transition(State.ATARI, State.QUES2, '"The $device is made by Atari! Is there anything you like about using Atari?"')
df.add_system_transition(State.PLAYSTATION, State.QUES2, '"The $device is made by Playstation! Is there anything you like about using a Playstation console?"')
df.add_system_transition(State.NINTENDO, State.QUES2, '"The $device is made by Nintendo! Is there anything you like about using a Nintendo device?"')
df.add_system_transition(State.XBOX, State.QUES2, '"The $device is made by Xbox! Is there anything you like about using an Xbox console?"')
df.add_system_transition(State.PC, State.QUES2, '"Is there anything you like about gaming with a PC?"')
df.add_system_transition(State.SEGA, State.QUES2, '"The $device is made by Sega! Is there anything you like about using a Sega device?"')
